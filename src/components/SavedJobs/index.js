...
const savedJobsData = [
  {
    ...
    ctc: "12",
    description:
      "We are looking for a young trained designer to help us to create stunning websites and app",
    role: "Java Developer",
...
const savedJobsNewData = [
  ...
  },
  {
    ...
    companyName: "Uber",
    companyLogo:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Uber_App_Icon.svg/2048px-Uber_App_Icon.svg.png",
    ctc: "22",
    description:
  ...
  },
  {
    ...
    companyName: "SpaceX",
    companyLogo:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/SpaceX_logo_black.svg/2048px-SpaceX_logo_black.svg.png",
    ctc: "30",
    description:
  ...
  },
  {
    ...
    companyName: "Twitter",
    companyLogo:
      "https://upload.wikimedia.org/wikipedia/en/thumb/9/9f/Twitter_bird_logo_2012.svg/2048px-Twitter_bird_logo_2012.svg.png",
    ctc: "18",
    description:
  ...
  },
  {
    ...
    companyName: "Intel",
    companyLogo:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Intel-logo.svg/2048px-Intel-logo.svg.png",
    ctc: "25",
    description:
      ...
      <div className="saved-jobs-container">
        ...
        <ul className="saved-jobs-ul-container">
          {savedJobsNewData.map((each) => {
            return (
              <li key={each.id} className="saved-jobs-card-container">
                <img
                  src={each.companyLogo}
                  alt="saved job logo image"
                  className="saved-job-company-logo"
                />
                <div className="saved-jobcard-details-container">
                  ...
                  <div className="saved-jobcard-btn-savedicon">
                    ...
                    <img
                      src="https://res.cloudinary.com/dtnhhgwlo/image/upload/v1701440294/SaveiconBlue_ntaomj.png"
                      className="save-icon-blue"
                    />
                  </div>
                </div>
